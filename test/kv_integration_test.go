...
func (kvSuite *KvTestSuite) generateRandomSampleFrame(size int, columnNames []string) frames.Frame {
...
func (kvSuite *KvTestSuite) generateSequentialSampleFrame(size int, columnNames []string) frames.Frame {
	var icol frames.Column
...
//
//	kvSuite.T().Log("write")
//	frame := kvSuite.generateRandomSampleFrame(5, []string{"n1", "n2", "n3"})
...
//
//	frame := kvSuite.generateRandomSampleFrame(5, []string{"n1", "n2"})
//
//	wreq := &frames.WriteRequest{
//		Backend: kvSuite.backendName,
//		Table:   table,
...
//	frame2 := kvSuite.generateRandomSampleFrame(5, newColumns)
//	wreq = &frames.WriteRequest{
//		Backend:  kvSuite.backendName,
//		Table:    table,
...
//
//	newColumns := []string{"n3", "n4"}
//	frame := kvSuite.generateRandomSampleFrame(5, newColumns)
//	wreq := &frames.WriteRequest{
//		Backend:  kvSuite.backendName,
//		Table:    table,
//		SaveMode: frames.Overwrite,
...
//	frame := kvSuite.generateRandomSampleFrame(3, columnNames)
//	wreq := &frames.WriteRequest{
//		Backend: kvSuite.backendName,
//		Table:   table,
//	}
...
//
//	// Save a frame to the same path
//	frame2 := kvSuite.generateRandomSampleFrame(2, columnNames)
//
//	wreq = &frames.WriteRequest{
//		Backend:  kvSuite.backendName,
//		Table:    table,
...
//
//	columnNames := []string{"n1", "n2"}
//	frame := kvSuite.generateSequentialSampleFrame(3, columnNames)
//	wreq := &frames.WriteRequest{
//		Backend: kvSuite.backendName,
//		Table:   table,
//	}
...
//	frame2 := kvSuite.generateSequentialSampleFrame(3, newColumnNames)
//
//	wreq = &frames.WriteRequest{
//		Backend:  kvSuite.backendName,
//		Table:    table,
...
func (kvSuite *KvTestSuite) TestSaveModeAppendSameAttributeDifferentValues() {
	...
	// Save a frame to the same path
	frame2 := kvSuite.generateSequentialSampleFrame(3, columnNames)
