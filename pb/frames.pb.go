...
// UnimplementedFramesServer can be embedded to have forward compatible implementations.
type UnimplementedFramesServer struct {
}

func (*UnimplementedFramesServer) Read(req *ReadRequest, srv Frames_ReadServer) error {
	return status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (*UnimplementedFramesServer) Write(srv Frames_WriteServer) error {
	return status.Errorf(codes.Unimplemented, "method Write not implemented")
}
func (*UnimplementedFramesServer) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedFramesServer) Delete(ctx context.Context, req *DeleteRequest) (*DeleteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (*UnimplementedFramesServer) Exec(ctx context.Context, req *ExecRequest) (*ExecResponse, error) {
